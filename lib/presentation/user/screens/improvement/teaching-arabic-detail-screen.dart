...
class TeachingArabicDetailScreen extends StatefulWidget {


  const TeachingArabicDetailScreen({super.key,});

  @override
  _TeachingArabicDetailScreenState createState() => _TeachingArabicDetailScreenState();
}

class _TeachingArabicDetailScreenState extends State<TeachingArabicDetailScreen> {
  int _currentStep = 0;
        ...
        children: [
          const Expanded(
            ...
            child: Padding(
              ...
              child: Center(
                child: Text(
                  'Steps to Improve Teaching Arabic',
