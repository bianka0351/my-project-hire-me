...
class TeachingEnglishDetailScreen extends StatefulWidget {


  const TeachingEnglishDetailScreen({super.key,});

  @override
  _TeachingEnglishDetailScreenState createState() => _TeachingEnglishDetailScreenState();
}

class _TeachingEnglishDetailScreenState extends State<TeachingEnglishDetailScreen> {
  int _currentStep = 0;
        ...
        children: [
          const Expanded(
            ...
            child: Padding(
              ...
              child: Center(
                child: Text(
                  'Steps to Improve Teaching English',
