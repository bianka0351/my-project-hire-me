...
class FlutterDetailScreen extends StatefulWidget {


  const FlutterDetailScreen({super.key,});

  @override
  _FlutterDetailScreenState createState() => _FlutterDetailScreenState();
}

class _FlutterDetailScreenState extends State<FlutterDetailScreen> {
  int _currentStep = 0;
