...
class FrontEndDetailScreen extends StatefulWidget {


  const FrontEndDetailScreen({super.key,});

  @override
  _FrontEndDetailScreenState createState() => _FrontEndDetailScreenState();
}

class _FrontEndDetailScreenState extends State<FrontEndDetailScreen> {
  int _currentStep = 0;
